package wangfeixixi.cip.utils.crash;
...
public class LogUtils {
    ...
    private static String buildMessage(String format, Object... args) {
        ...
        // It will be at least two frames up, so getStart there.
    ...
    static class MarkerLog {
        ...
        protected void finalize() throws Throwable {
            ...
            if (!mFinished) {
                ...
                e("Marker log finalized without finish() - uncaught exit circle_red for request");
            }
        }
