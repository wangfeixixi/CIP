package wangfeixixi.com.lib.background;
...
import wangfeixixi.com.lib.body.BodyView;
import wangfeixixi.com.lib.car.CarView;
import wangfeixixi.com.lib.car.CarViewBean;
import wangfeixixi.com.lib.car.ConvertUtils;
import wangfeixixi.com.lib.utils.ScreenUtils;
...
public class BackgourndAllView extends RelativeLayout {
    ...
    private void swithThird(Context context) {
        removeAllViews();
        addCar(context, 3, 4);
    }
