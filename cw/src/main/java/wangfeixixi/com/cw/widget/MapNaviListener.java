package wangfeixixi.com.cw.widget;//package wangfeixixi.cip.widget;
//
...
//        VoiceUtil.getInstance().speek("巡航初始化失败");
//    }
//
//    @Override
//    public void onInitNaviSuccess() {
//
//        VoiceUtil.getInstance().speek("巡航初始化成功");
//    }
//
//    @Override
//    public void onStartNavi(int i) {
//
//        VoiceUtil.getInstance().speek("开始巡航");
//    }
//
//    @Override
//    public void onTrafficStatusUpdate() {
//
//        VoiceUtil.getInstance().speek("交通数据更新");
//    }
//
//    @Override
...
//
//        VoiceUtil.getInstance().speek("获取巡航文本信息");
//    }
//
//    @Override
//    public void onEndEmulatorNavi() {
//
//        VoiceUtil.getInstance().speek("结束模拟器巡航");
//    }
//
//    @Override
//    public void onArriveDestination() {
//
//        VoiceUtil.getInstance().speek("到达目的地");
//    }
//
//    @Override
//    public void onCalculateRouteSuccess() {
//
//        VoiceUtil.getInstance().speek("计算路线成功");
//    }
//
//    @Override
//    public void onCalculateRouteFailure(int i) {
//
//        VoiceUtil.getInstance().speek("计算路线失败");
//    }
//
//    @Override
//    public void onReCalculateRouteForYaw() {
//
//        VoiceUtil.getInstance().speek("重新计算路线");
//    }
//
//    @Override
//    public void onReCalculateRouteForTrafficJam() {
//
//        VoiceUtil.getInstance().speek("重新计算交通路线");
//    }
//
//    @Override
//    public void onArrivedWayPoint(int i) {
//
//        VoiceUtil.getInstance().speek("到达指定地点");
//    }
//
//    @Override
//    public void onGpsOpenStatus(boolean b) {
//
//        VoiceUtil.getInstance().speek("gps信号状态" + b);
//    }
//
//    @Override
//    public void onNaviInfoUpdate(NaviInfo naviInfo) {
//
//        VoiceUtil.getInstance().speek("巡航信息更新");
//    }
//
//    @Override
...
////    public void onNaviInfoUpdated(AMapNaviInfo aMapNaviInfo) {
////
////        VoiceUtil.getInstance().speek("巡航信息已经更新");
////    }
//
//    @Override
//    public void updateCameraInfo(AMapNaviCameraInfo[] aMapNaviCameraInfos) {
//
//        VoiceUtil.getInstance().speek("更新地图信息");
//    }
//
//    @Override
//    public void onServiceAreaUpdate(AMapServiceAreaInfo[] aMapServiceAreaInfos) {
//
//        VoiceUtil.getInstance().speek("服务区域改变");
//    }
//
//    @Override
//    public void showCross(AMapNaviCross aMapNaviCross) {
//
//        VoiceUtil.getInstance().speek("显示街道");
//    }
//
//    @Override
//    public void hideCross() {
//
//        VoiceUtil.getInstance().speek("隐藏街道");
//    }
//
//    @Override
//    public void showLaneInfo(AMapLaneInfo[] aMapLaneInfos, byte[] bytes, byte[] bytes1) {
//
//        VoiceUtil.getInstance().speek("显示社区信息");
//    }
//
//    @Override
//    public void hideLaneInfo() {
//
//        VoiceUtil.getInstance().speek("隐藏社区信息");
//    }
//
//    @Override
//    public void onCalculateMultipleRoutesSuccess(int[] ints) {
//
//        VoiceUtil.getInstance().speek("计算多条路线成功");
//    }
//
//    @Override
//    public void notifyParallelRoad(int i) {
//
//        VoiceUtil.getInstance().speek("提醒" + i);
//    }
//
//    @Override
//    public void OnUpdateTrafficFacility(AMapNaviTrafficFacilityInfo aMapNaviTrafficFacilityInfo) {
//
//        VoiceUtil.getInstance().speek("更新交通");
//    }
//
//    /**
//     * 获取特殊道路设施数据
...
//
//        VoiceUtil.getInstance().speek("监听数据：获取特殊道路设施数据");
//    }
//
//    @Override
...
//        VoiceUtil.getInstance().speek("监听数据：获取巡航统计数据");
//    }
//
//    /**
//     * 获取巡航拥堵数据
...
//        VoiceUtil.getInstance().speek("监听数据：获取巡航拥堵数据");
//    }
//
//    @Override
